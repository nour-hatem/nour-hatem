...
- **LLMs & RAG** — Fine-tuning, retrieval-augmented generation, and agentic pipelines
- **Vision Transformers** — ViT, Swin Transformer, modern CV architectures
- **AI Agents** — Tool use, multi-step reasoning, autonomous task execution
- **Production ML** — Model monitoring, versioning, and CI/CD for ML systems
